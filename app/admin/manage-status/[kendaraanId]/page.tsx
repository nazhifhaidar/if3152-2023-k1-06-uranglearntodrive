...
import EditStatusKendaraan from './EditStatusKendaraan'
...
<AppBar > <LoginLogout></LoginLogout></AppBar> 
      <Row>
        ...
        <Link href={"/admin/manage-status"}><h2 style={CurrentPageStyle}>Manage Status Kendaraan</h2></Link> 
        ...
        <Link href={"/admin/manage-jadwal"}><h2 style={{paddingLeft:'8px'}}>Manage Jadwal Kelas</h2></Link>
          ...
          <div className='pl-4'>
            <EditStatusKendaraan id={params.kendaraanId}/>
          </div>
      </Row>
    </div>
  )
